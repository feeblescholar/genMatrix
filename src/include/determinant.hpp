...
/**
* @brief Kiszámítja a mátrix determinánsát.
* @details Kiszámítja a mátrix determinánsát a Bareiss-alogritmussal. Az algoritmus 
*          kifejezetten hasznos, mert kizárólag egészekkel dolgozik, így nem zavarnak 
*          be a lebegőpontos aritmetikai hibák. A megoldás pontos, az előbbiek 
*          miatt 0-ás epsilonnal tesztelhető.
* @return A mátrix determinánsa a mátrix típusának megfelelően.
* @throw Matrix_Error kivétel, ha nem létezik.
* @warning A mátrix mérete erősen befolyásolja a futási időt (O(n^3)). Nagy értékek 
*          esetén előfordulhat integer overflow, ennek elkerülése érdekében minden 
*          típust int128-ra emelünk a számítás idejére.
*/
