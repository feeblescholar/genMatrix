...
Matrix_Error::Matrix_Error(const char *_src, const char *_msg, bool fatal = false) : isFatal(fatal), src_func(nullptr), msg(nullptr) {
...
const char* Matrix_Error::src() const {
    return src_func;
}

const char* Matrix_Error::what() const {
    return msg;
}
